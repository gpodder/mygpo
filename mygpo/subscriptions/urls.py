...
urlpatterns = [
    ...
    path('download/subscriptions.opml',
        views.download_all,
        name='subscriptions-opml'),

    path('user/<username:username>/subscriptions/rss/',
        views.subscriptions_feed,
        name='shared-subscriptions-rss'),

    path('user/<username:username>/subscriptions',
        views.for_user,
        name='shared-subscriptions'),

    path('user/<username:username>/subscriptions.opml',
        views.for_user_opml,
